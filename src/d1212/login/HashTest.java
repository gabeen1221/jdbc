...
public class HashTest {
	...
	public static void main(String[] args) {
		...
		//				대표적으로 sha256, sha512 함수등은 256비트 또는 512비트 길이로 해시값 만듭니다.
		//				외부라이브러리 guava를 사용하면 sha256 메소드가 있습니다. 
	
		//평문 1122를 sha256함수로 해시값을 만들면?
		String hval = Hashing.sha256()
				.hashString("1122", StandardCharsets.UTF_8)	//첫번째 인자값의 인코딩 형식
				.toString();
