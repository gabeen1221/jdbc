...
public class OracleConnectionTest {
	...
	public static void main(String[] args) {
		...
		//db접속 정보
		String url = "jdbc:oracle:thin:@localhost:1521:XE";   //데이터베이스 URL - 디비버에서 확인가능합니다. jdbc:oracle:thin는 지정된 프로토콜
		...
		String user ="system";			//접속할 계정 정보 - 계정이름
		String password="1234";				//            ㄴ 패스워드
		
		try {			//오류 처리
			//1.메모리에 데이터베이스 드라이버 클래스를 로드합니다.(로드 -> 적재) throws ClassNotFoundException 처리.
